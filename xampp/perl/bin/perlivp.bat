...
#!perl
#line 29
    eval 'exec C:\Users\jakel\Documents\GitHub\Team11Project\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\jakel\Documents\GitHub\Team11Project\xampp\perl\bin\perl.exe';
